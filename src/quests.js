...
export const QUESTS = {
  ...
  'q-main-fragments': {
    ...
    steps: [
      ...
      "Voyage en Préhistoire (Les Portes-en-Ré) et trouve le 2ᵉ fragment.",
      "Voyage en Antiquité (Sainte-Marie-de-Ré) et trouve le 3ᵉ fragment.",
      "Voyage au Moyen Âge (La Flotte) et trouve le 4ᵉ fragment.",
      "Voyage au XVIIᵉ siècle (Saint-Martin-de-Ré) et trouve le 5ᵉ fragment.",
      "Voyage au XIXᵉ siècle (Ars-en-Ré) et trouve le 6ᵉ fragment.",
      "Voyage en 1940-45 (Le Bois-Plage) et trouve le 7ᵉ fragment.",
  ...
  'q-antiquite-amphores': {
    ...
    era: 'antiquite',
    steps: [
      "Retrouve 3 amphores égarées autour de Sainte-Marie.",
      "Reviens voir Lucius.",
    ],
  ...
  'q-wwii-messages': {
    ...
    era: 'wwii',
    steps: [
      "Porte le message codé à Hélène, près de l'église du Bois-Plage.",
  ...
  'q-contemp-anomalie': {
    ...
    era: 'contemporaine',
    steps: [
      "Trouve la source des bruits étranges au pied du Phare des Baleines.",
